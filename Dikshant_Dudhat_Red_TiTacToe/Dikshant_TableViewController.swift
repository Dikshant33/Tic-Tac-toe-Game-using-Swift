...
class Dikshant_TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "dikshant_tablecell", for: indexPath) as! Dikshant_TableViewCell
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let whichCell = sender as! Dikshant_TableViewCell
        let destinationView = segue.destination as! Dikshant_ViewController
        
        destinationView.replyingPastGame = true
